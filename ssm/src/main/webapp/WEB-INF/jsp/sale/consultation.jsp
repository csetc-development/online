...
<body>
	<div id="distribution">
		<form id="Screenform" enctype="multipart/form-data">
			...
			<select id="timeselect" name="remark">
			...
			<select id="validityselect" name="validityid">
				<option value="">有效性</option>
			</select>
			<select id="customertypeselect" name="ctypeid">
				<option value="">客户类型</option>
			</select>
			<select id="nowcoursepeopleselect" name="nowcoursepeople">
				<option value="">课程顾问</option>
			</select>
			<select id="customerlabelselect" name="clabelid">
				<option value="">标签</option>
			</select>
			<select id="intentionjobselect" name="intentionjob">
